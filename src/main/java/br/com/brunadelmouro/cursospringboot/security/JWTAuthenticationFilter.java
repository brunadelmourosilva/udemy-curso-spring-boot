package br.com.brunadelmouro.cursospringboot.security;

import br.com.brunadelmouro.cursospringboot.dto.CredentialsDTO;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            ...
            Authentication auth = authenticationManager.authenticate(authToken); //user and password are valid
            return auth;
        }
        catch (IOException e) {
