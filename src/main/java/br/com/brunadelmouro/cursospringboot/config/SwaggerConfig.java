...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.brunadelmouro.cursospringboot.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                new Contact("Bruna Delmouro", "udemy.com/user/nelio-alves", "brunadelmouro@gmail.com"),
